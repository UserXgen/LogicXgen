...
void main(int argc, char *argv[]) // argument count(подсчёт), argument values(значение)
{
...
void zad1() // генерация взвешанных графов
{
...
void zad1_nevzv() // генерация невзвешанных графов
{
	setlocale(LC_ALL, "russian");
...
void zad1_2(int st) // работа с неориентированным графом
{
	int r, i = 0;
...
void zad1_3(int st) // работа с ориентированным графом
{
	int r, i = 0;
